...
const AuthorSection = () => (
  <section className="py-20 bg-secondary">
    <div className="container mx-auto px-6 lg:px-8 grid md:grid-cols-2 gap-14 items-center max-w-4xl">
      <FadeIn>
        <img
          src={portrait}
      ...
      <FadeIn delay={0.15}>
        ...
        <h2 className="text-3xl md:text-4xl font-serif mb-2">Erika Sun</h2>
        ...
        <p className="text-sm text-muted-foreground leading-relaxed mb-3 font-sans">
          ...
          when building intellectual autonomy.
        </p>
        <p className="text-sm text-muted-foreground leading-relaxed mb-6 font-sans">
          Her work bridges classroom practice and cognitive theory, giving educators a
          structural lens to make thinking explicit, observable, and teachable.
        </p>
        <Link
          to="/about"
