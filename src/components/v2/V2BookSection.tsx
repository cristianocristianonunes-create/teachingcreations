      ...
      <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <FadeIn delay={0.15}>
          ...
          <p className="text-base text-[#555555] leading-relaxed font-sans mb-4">
            This book presents the practical, coherent framework for designing literacy instruction that is accessible, rigorous, and sustainable.
          </p>
          <p className="text-base text-[#555555] leading-relaxed font-sans mb-6">
            Move from simple reading interaction to meaningful writing — with coherence across every instructional layer.
          </p>
          <a
