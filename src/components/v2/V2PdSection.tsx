...
const V2PdSection = () => {
  ...
  const outcomes = [
    get("pd_outcome_1", "Coherent literacy planning across reading, writing, and vocabulary"),
    get("pd_outcome_2", "Immediate classroom application within the same instructional cycle"),
    get("pd_outcome_3", "Rigorous multilingual learner support without lowering expectations"),
  ];
  return (
    ...
    <div className="container mx-auto px-6 lg:px-8 max-w-3xl text-center">
      <FadeIn>
        <h2 className="text-3xl md:text-[40px] font-serif font-bold text-white mb-4 leading-tight">
          {get("pd_title", "Bring The Cycle of Thinking™ to Your School or District")}
        </h2>
        <p className="text-base text-white/70 font-sans leading-relaxed mb-8 max-w-2xl mx-auto">
          {get("pd_description", "Customized professional development designed for schools and districts seeking coherent literacy instruction aligned to multilingual learner needs. We partner with you to build capacity, improve student outcomes, and create a sustainable culture of deep thinking.")}
        </p>
        ...
        <div>
          ...
          >
            {get("pd_cta", "Request Professional Development")}
          </Link>
        </div>
      </FadeIn>
    </div>
